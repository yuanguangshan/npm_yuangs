...
export interface ModelAdapter {
    ...
    /** 执行任务 */
    execute(prompt: string | AIRequestMessage[], // 支持字符串或结构化消息列表
    config: TaskConfig, onChunk?: (chunk: string) => void): Promise<ModelExecutionResult>;
    /** 健康检查 */
 ...
 * 探索策略
 */
export declare enum ExplorationStrategy {
    NONE = "none",
