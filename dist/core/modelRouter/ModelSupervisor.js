...
exports.ModelSupervisor = void 0;
...
class ModelSupervisor {
     ...
     * 核心决策评估函数 (Replayable)
     */
    evaluate(snapshot, ctx, currentStrategy) {
        ...
        for (const trigger of this.config.triggers) {
            ...
            if (this.checkCondition(metricValue, trigger.operator, trigger.threshold)) {
                ...
                if (currentHits >= (trigger.hysteresisCount || 1)) {
                    if (currentStrategy === trigger.action.targetStrategy)
                        continue;
                    ...
                    const action = {
                        type: types_1.ActionType.SWITCH_STRATEGY,
            ...
            triggers: [
                {
                    ...
                    action: {
                        type: types_1.ActionType.SWITCH_STRATEGY,
                        targetStrategy: types_1.RoutingStrategy.FASTEST_FIRST
                    }
                },
                {
                    ...
                    action: {
                        type: types_1.ActionType.SWITCH_STRATEGY,
                        targetStrategy: types_1.RoutingStrategy.CHEAPEST_FIRST
                    }
                }
            ]
        };
...
exports.ModelSupervisor = ModelSupervisor;
//# sourceMappingURL=ModelSupervisor.js.map