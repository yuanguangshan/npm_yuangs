    ...
    protected score(
        ...
        return adapters.map(adapter => {
            ...
            if (weights.taskMatch) {
                ...
                if (isSupported) reasons.push('任务类型匹配');
            }
            ...
            if (weights.context) {
                ...
                if (ratio > 0.8) reasons.push('上下文资源充足');
            }
            ...
            if (weights.latency) {
                ...
                if (score > 0.8) reasons.push('响应速度快');
            }
            ...
            if (weights.history) {
                ...
                if (score > 0.9) reasons.push('历史表现非常稳定');
            }
            ...
            if (weights.quality) {
                ...
                if (isSpecialist) reasons.push('领域专家模型');
            }
